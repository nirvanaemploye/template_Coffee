      ...
      <div className="container mx-auto sm:p-6">
        <div className="flex flex-col gap-10">
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="border-b-2 sm:text-2xl font-bold">
                  <th className="text-left p-4 font-semibold md:ps-24">  Product</th>
          ...
          <div className="w-full lg:w-1/3 ms-auto">
            <div data-aos="fade-left" className="bg-[#242425] text-white p-6">
              <h2 className="text-xl font-bold mb-4 text-primary">
                Cart Totals
              </h2>
              <div className="border border-white/40 bg-[#2D2C2C] p-4 space-y-2">
                ...
                <div className="flex justify-between text-lg font-bold border-t border-white/40 pt-2">
                  <span>Total:</span>
