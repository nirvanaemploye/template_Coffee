      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="absolute  top-[72px] w-screen text-center z-50 lg:hidden bg-primary/90 text-white py-6 rounded-sm shadow-lg"
          >
            <ul className="text-lg font-semibold uppercase space-y-4 sm:text-2xl sm:space-y-6">
