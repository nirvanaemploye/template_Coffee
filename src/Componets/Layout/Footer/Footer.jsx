      ...
      <div className="container text-white p-10">
        <div data-aos="fade" className="grid grid-cols-1 lg:grid-cols-3 gap-y-8 ">
          ...
          <div className="xl:space-y-12 space-y-6">
            <h1 className="font-semibold text-2xl md:text-3xl flex items-baseline gap-x-2 mt-auto treacking-3"><span><img src={logo} alt="" className="sm:w-10 w-10" /></span>BrewBeans</h1>
